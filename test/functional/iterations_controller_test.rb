...
class IterationsControllerTest < ActionController::TestCase
  ...
  test "should create iteration" do
    assert_difference('Iteration.count') do
      post :create, iteration: { description: @iteration.description, end_date: @iteration.end_date, name: @iteration.name, project_id: @iteration.project_id, start_date: @iteration.start_date }
    end
  ...
  test "should update iteration" do
    put :update, id: @iteration, iteration: { description: @iteration.description, end_date: @iteration.end_date, name: @iteration.name, project_id: @iteration.project_id, start_date: @iteration.start_date }
    assert_redirected_to iteration_path(assigns(:iteration))
  end
